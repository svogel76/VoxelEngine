...
Aktueller Stand: VoxelEngine.Api noch nicht extrahiert.
VoxelEngine.Game ist noch Executable (wird kuenftig Mod-DLL).
...
- Engine-Lifecycle: `EngineRunner` + `IGame`:
...
VoxelEngine.Api.dll          <- einzige Abhaengigkeit fuer Mods
    ...
    IEntity, IGameContext    <- bestehende Interfaces wandern hierher
